...
import {
    ...
    getUserInfoController} from '../controllers/authController.js'
import {
    getCourseController,
    purchaseCourseController,
    showCourseController,
    soldCoursesController
...
router.post("/course_purchase", requireSignIn, purchaseCourseController);
router.get("/user/allcourse/:userId", requireSignIn, showCourseController);
...
router.get("/admin/sold/courses", requireSignIn, isAdmin, soldCoursesController);
